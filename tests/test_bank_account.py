...
class TestCourse(unittest.TestCase):
    ...
    def test_init_valid_input_attributes_set(self):
        # Arrange and Act
        account = BankAccount(123,321,100001.1111)

        # Assert
        self.assertEqual(123,account._BankAccount__account_number)
        self.assertEqual(321,account._BankAccount__client_number)
        self.assertAlmostEqual(100001.1111, account._BankAccount__balance, places=4)


    def test_init_incalid_input_account_number(self):
        # Arrange, Act and Assert
        with self.assertRaises(ValueError):
            account = BankAccount("aaa",321,100001.1111)

    def test_init_invalid_input_client_number(self):
        # Arrange, Act and Assert
        with self.assertRaises(ValueError):
            account = BankAccount(123,"KFC",100001.1111)

    def test_init_invalid_input_balance(self):
        # Arrange and Act
        account = BankAccount(123,321,"BBB")

        # Assert
        self.assertEqual(0,account._BankAccount__balance)
    ...
    def test_deposit_valid(self):
        ...
        account.deposit(50)
        self.assertAlmostEqual(150, account._BankAccount__balance)
    ...
    def test_withdraw_valid(self):
        account = BankAccount(1, 1, 100)
        account.withdraw(40)
        self.assertAlmostEqual(60, account._BankAccount__balance)
    ...
    def test_update_balance_valid(self):
        ...
        self.assertAlmostEqual(500.55, account._BankAccount__balance)
    ...
    def test_account_number_accessor(self):
        account = BankAccount(123, 456, 789.0)
    ...
    def test_str_output_format(self):
        account = BankAccount(12345, 67890, 1500.756)
        expected_str = "Account Number: 12345 Balance: $1,500.76"
